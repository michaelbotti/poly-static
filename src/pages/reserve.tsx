...
function IndexPage() {
  ...
  const [alreadyReserverd, setAlreadyReserved] = useState<boolean>(false);
  return (
    <Layout>
          ...
          <div className="col-span-12 lg:col-span-8 lg:col-start-3 relative z-10">
            {alreadyReserverd ? (
              <>
                ...
                <Link className="text-primary-100 font-bold underline" to="/">
              ...
              <>
                ...
                <div className="max-w-1/2 mx-auto">
                  {user ? (
                    <p className="text-xl mb-8">
                      <strong>Done!</strong> Your Twitter handle is now reserved
                      for you.
                      <br />{" "}
                      <a
                    ...
                    <>
                      <p className="text-xl mb-8 lg:w-1/2 mx-auto">
                        And we'll reserve your handle for{" "}
                        <strong>up to two weeks</strong> after our launch day
                        (to be announced).
                      </p>
                      <button
                        onClick={async () => {
                        ...
                        className={`px-8 py-4 rounded text-white bg-primary-100 ${
